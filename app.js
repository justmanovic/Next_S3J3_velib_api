...
const getVelibStations = async () => {
  ...
  myJson.records.forEach(station => {
    ...
    html = `<ul><li><b>Nom de la station : </b>${station.fields.name}</li><li><b>Nombre de vélos mécaniques: </b>${station.fields.mechanical}</li><li><b>Nombre de vélos électriques: </b>${station.fields.ebike}</li></ul>`
